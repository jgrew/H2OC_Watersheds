...
class DetailPanel extends Widget {
    ...
    render() {
        ...
        const show =
            share || introductionTitle || introductionContent ? '' : 'hide';
        ...
        return (
            <div
                ...
                class={this.classes(
                    show,
                    CSS.calciteStyles.panel,
                    CSS.calciteStyles.panelNoPadding
                )}
            >
                <button
                    bind={this}
                ...
                <h3 class={this.classes(CSS.detailsTitle)}>
                    {introductionTitle}
                </h3>
                <p
                    class={this.classes(CSS.detailsContent)}
                    innerHTML={introductionContent}
                />
                {socialShare}
            </div>
        );
    }
    private _hidePanel(e: any) {
        const container = this.container as HTMLElement;
        e.target.title = container.classList.contains('collapse')
            ? 'Close'
