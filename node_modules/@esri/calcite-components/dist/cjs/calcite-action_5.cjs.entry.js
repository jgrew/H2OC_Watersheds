...
const CalciteActionGroup = class {
  ...
  renderMenu() {
    ...
    return hasMenuItems ? (index.h("calcite-action-menu", { expanded: expanded, flipPlacements: ["left", "right"], intlOptions: intlOptions, open: menuOpen, placement: "leading-start" }, index.h("slot", { name: SLOTS$1.menuActions }))) : null;
  }
  render() {
...
const CalciteActionMenu = class {
  ...
  renderMenuButton() {
    ...
    return (index.h("calcite-action", { active: open, "aria-controls": menuId, "aria-expanded": open.toString(), "aria-haspopup": "true", class: CSS$2.menuButton, icon: ICONS$1.menu, id: menuButtonId, label: optionsText, onClick: this.menuButtonClick, onKeyDown: this.menuButtonKeyDown, onKeyUp: this.menuButtonKeyUp, ref: this.setMenuButtonRef, text: optionsText, textEnabled: expanded }));
  }
  renderMenuItems() {
    ...
    return (index.h("calcite-popover", { disablePointer: true, label: label, offsetDistance: offsetDistance, open: open, placement: placement, referenceElement: menuButtonEl }, index.h("div", { "aria-activedescendant": activeDescendantId, "aria-labelledby": menuButtonId, class: CSS$2.menu, id: menuId, onKeyDown: this.menuActionsContainerKeyDown, onKeyUp: this.menuActionsContainerKeyUp, ref: (el) => (this.menuEl = el), role: "menu", tabIndex: -1 }, index.h("slot", null))));
  }
  render() {
...
const CalciteActionPad = class {
  ...
  renderBottomActionGroup() {
    ...
    const expandToggleNode = !expandDisabled ? (index.h(CalciteExpandToggle, { el: el, expanded: expanded, intlCollapse: collapseLabel, intlExpand: expandLabel, position: position, ref: this.setExpandToggleRef, toggle: toggleExpand, tooltip: tooltipExpand })) : null;
    return expandToggleNode ? (index.h("calcite-action-group", { class: CSS$3.actionGroupBottom }, expandToggleNode)) : null;
  }
  render() {
