...
const utils = require('./utils-2e274f9a.js');
...
const CalciteColorPicker = class {
  constructor(hostRef) {
    ...
    this.renderChannel = (value, index$1, label, ariaLabel) => (index.h("calcite-input", { "aria-label": ariaLabel, class: CSS.channel, "data-channel-index": index$1, numberButtonType: "none", onChange: this.handleChannelChange, onInput: this.handleChannelInput, onKeyDown: this.handleChannelKeyUpOrDown, onKeyUp: this.handleChannelKeyUpOrDown, prefixText: label, scale: "s", type: "number", value: value !== null ? value.toString() : "" }));
    this.deleteColor = () => {
  ...
  render() {
    ...
    return (index.h("div", { class: CSS.container }, index.h("canvas", { class: {
        [CSS.colorFieldAndSlider]: true,
        [CSS.colorFieldAndSliderInteractive]: colorFieldAndSliderInteractive
      }, onMouseEnter: this.handleColorFieldAndSliderMouseEnterOrMove, onMouseLeave: this.handleColorFieldAndSliderMouseLeave, onMouseMove: this.handleColorFieldAndSliderMouseEnterOrMove, ref: this.initColorFieldAndSlider }), hideHex && hideChannels ? null : (index.h("div", { class: { [CSS.controlSection]: true, [CSS.section]: true } }, hideHex ? null : (index.h("div", { class: CSS.hexOptions }, index.h("span", { class: {
        [CSS.header]: true,
        [CSS.headerHex]: true,
        [CSS.underlinedHeader]: true
      } }, intlHex), index.h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, class: CSS.control, dir: elementDir, onCalciteColorPickerHexInputChange: this.handleHexInputChange, ref: this.storeHexInputRef, scale: hexInputScale, theme: theme, value: selectedColorInHex }))), hideChannels ? null : (index.h("calcite-tabs", { class: {
        [CSS.colorModeContainer]: true,
        [CSS.splitSection]: true
      }, dir: elementDir }, index.h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (index.h("div", { class: { [CSS.savedColorsSection]: true, [CSS.section]: true } }, index.h("div", { class: CSS.header }, index.h("label", null, intlSaved), index.h("div", { class: CSS.savedColorsButtons }, index.h("calcite-button", { appearance: "transparent", "aria-label": intlDeleteColor, class: CSS.deleteColor, color: "neutral", disabled: noColor, iconStart: "minus", onClick: this.deleteColor, scale: scale, theme: theme }), index.h("calcite-button", { appearance: "transparent", "aria-label": intlSaveColor, class: CSS.saveColor, color: "neutral", disabled: noColor, iconStart: "plus", onClick: this.saveColor, scale: scale, theme: theme }))), savedColors.length > 0 ? (index.h("div", { class: CSS.savedColors }, [
      ...savedColors.map((color) => (index.h("calcite-color-picker-swatch", { active: selectedColorInHex === color, class: CSS.savedColor, color: color, key: color, onClick: this.handleSavedColorSelect, onKeyDown: this.handleSavedColorKeyDown, scale: scale, tabIndex: 0, theme: theme })))
    ])) : null))));
  }
  // --------------------------------------------------------------------------
  //
...
const CalciteColorPickerHexInput = class {
  constructor(hostRef) {
     ...
     * The hex value.
     */
    this.value = utils.normalizeHex(DEFAULT_COLOR$1.hex());
...
const CalciteColorPickerSwatch = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-label": hex, title: hex }, index.h("svg", { class: CSS$2.swatch, xmlns: "http://www.w3.org/2000/svg" }, index.h("rect", { fill: hex, height: "100%", rx: borderRadius, stroke: borderColor, width: "100%" }))));
  }
  static get watchers() { return {
    "color": ["handleColorChange"]
  }; }
