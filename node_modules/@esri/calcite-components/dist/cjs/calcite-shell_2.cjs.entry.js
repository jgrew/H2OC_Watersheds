...
const CalciteShellPanel = class {
  ...
  render() {
    ...
    const hasHeader = dom.getSlotted(el, SLOTS$1.header);
    const contentNode = (index.h("div", { class: { [CSS$1.content]: true, [CSS$1.contentDetached]: detached }, hidden: collapsed }, hasHeader ? index.h("slot", { name: SLOTS$1.header }) : null, index.h("slot", null)));
