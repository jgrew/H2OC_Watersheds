import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-527d390a.js';
import { g as getElementDir, d as getSlotted } from './dom-9b1c8e39.js';
...
const CalcitePanel = class {
  ...
  renderBackButton() {
    ...
    return showBackButton ? (h("calcite-action", { "aria-label": label, class: CSS$1.backButton, icon: icon, key: "back-button", onClick: backButtonClick, ref: this.setBackRef, scale: "s", slot: SLOTS.headerActionsStart, text: label })) : null;
  }
  renderHeaderContent() {
    const { heading, headingLevel, summary } = this;
    const headingNode = heading ? (h(CalciteHeading, { class: CSS$1.heading, level: headingLevel }, heading)) : null;
    const summaryNode = summary ? h("span", { class: CSS$1.summary }, summary) : null;
    return headingNode || summaryNode ? (h("div", { class: CSS$1.headerContent, key: "header-content" }, headingNode, summaryNode)) : null;
  }
  /**
   * Allows user to override the entire header-content node.
   */
  renderHeaderSlottedContent() {
    return (h("div", { class: CSS$1.headerContent, key: "header-content" }, h("slot", { name: SLOTS.headerContent })));
  }
  renderHeaderStartActions() {
    const { el } = this;
    const hasStartActions = getSlotted(el, SLOTS.headerActionsStart);
    return hasStartActions ? (h("div", { class: { [CSS$1.headerActionsStart]: true, [CSS$1.headerActions]: true }, key: "header-actions-start" }, h("slot", { name: SLOTS.headerActionsStart }))) : null;
  }
  renderHeaderActionsEnd() {
    ...
    return hasEndActions || dismissibleNode ? (h("div", { class: { [CSS$1.headerActionsEnd]: true, [CSS$1.headerActions]: true }, key: "header-actions-end" }, slotNode, dismissibleNode)) : null;
  }
  renderMenu() {
  ...
  renderHeaderNode() {
    ...
    return actionsNodeStart ||
      ...
      actionsNodeEnd ||
      headerMenuNode ||
      showBackButton ? (h("header", { class: CSS$1.header }, backButtonNode, actionsNodeStart, headerContentNode, actionsNodeEnd, headerMenuNode)) : null;
  }
  /**
  ...
  renderFooterSlottedContent() {
    ...
    return hasFooterSlottedContent ? (h("footer", { class: CSS$1.footer }, h("slot", { name: SLOTS.footer }))) : null;
  }
  renderFooterActions() {
    const { el } = this;
    const hasFooterActions = getSlotted(el, SLOTS.footerActions);
    return hasFooterActions ? (h("footer", { class: CSS$1.footer }, h("slot", { name: SLOTS.footerActions }))) : null;
  }
  renderContent() {
    return (h("section", { class: CSS$1.contentContainer, onScroll: this.panelScrollHandler, tabIndex: 0 }, h("slot", null), this.renderFab()));
  }
  renderFab() {
    const { el } = this;
    const hasFab = getSlotted(el, SLOTS.fab);
    return hasFab ? (h("div", { class: CSS$1.fabContainer }, h("slot", { name: SLOTS.fab }))) : null;
  }
  render() {
