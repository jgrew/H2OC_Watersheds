import { r as registerInstance, f as forceUpdate, h, H as Host, g as getElement, c as createEvent } from './index-527d390a.js';
import { g as getElementDir, f as focusElement, d as getSlotted } from './dom-9b1c8e39.js';
...
const CalciteActionGroup = class {
  ...
  renderMenu() {
    ...
    return hasMenuItems ? (h("calcite-action-menu", { expanded: expanded, flipPlacements: ["left", "right"], intlOptions: intlOptions, open: menuOpen, placement: "leading-start" }, h("slot", { name: SLOTS$1.menuActions }))) : null;
  }
  render() {
...
const CalciteActionMenu = class {
  ...
  renderMenuButton() {
    ...
    const optionsText = intlOptions || TEXT$2.options;
    return (h("calcite-action", { active: open, "aria-controls": menuId, "aria-expanded": open.toString(), "aria-haspopup": "true", class: CSS$2.menuButton, icon: ICONS$1.menu, id: menuButtonId, label: optionsText, onClick: this.menuButtonClick, onKeyDown: this.menuButtonKeyDown, onKeyUp: this.menuButtonKeyUp, ref: this.setMenuButtonRef, text: optionsText, textEnabled: expanded }));
  }
  renderMenuItems() {
    const { actionElements, activeMenuItemIndex, open, menuButtonId, menuId, menuButtonEl, intlOptions, offsetDistance, placement } = this;
    const label = intlOptions || TEXT$2.options;
    const activeAction = actionElements[activeMenuItemIndex];
    const activeDescendantId = (activeAction === null || activeAction === void 0 ? void 0 : activeAction.id) || null;
    return (h("calcite-popover", { disablePointer: true, label: label, offsetDistance: offsetDistance, open: open, placement: placement, referenceElement: menuButtonEl }, h("div", { "aria-activedescendant": activeDescendantId, "aria-labelledby": menuButtonId, class: CSS$2.menu, id: menuId, onKeyDown: this.menuActionsContainerKeyDown, onKeyUp: this.menuActionsContainerKeyUp, ref: (el) => (this.menuEl = el), role: "menu", tabIndex: -1 }, h("slot", null))));
  }
  render() {
    return (h(Host, null, this.renderMenuButton(), this.renderMenuItems()));
  }
...
const CalciteActionPad = class {
  ...
  renderBottomActionGroup() {
    const { expanded, expandDisabled, intlExpand, intlCollapse, el, position, toggleExpand, tooltipExpand } = this;
    const expandLabel = intlExpand || TEXT$3.expand;
    const collapseLabel = intlCollapse || TEXT$3.collapse;
    const expandToggleNode = !expandDisabled ? (h(CalciteExpandToggle, { el: el, expanded: expanded, intlCollapse: collapseLabel, intlExpand: expandLabel, position: position, ref: this.setExpandToggleRef, toggle: toggleExpand, tooltip: tooltipExpand })) : null;
    return expandToggleNode ? (h("calcite-action-group", { class: CSS$3.actionGroupBottom }, expandToggleNode)) : null;
  }
  render() {
