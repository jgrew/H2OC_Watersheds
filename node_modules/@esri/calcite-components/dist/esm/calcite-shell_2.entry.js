...
import { d as getSlotted } from './dom-9b1c8e39.js';
...
const CalciteShellPanel = class {
  ...
  render() {
    ...
    const hasHeader = getSlotted(el, SLOTS$1.header);
    const contentNode = (h("div", { class: { [CSS$1.content]: true, [CSS$1.contentDetached]: detached }, hidden: collapsed }, hasHeader ? h("slot", { name: SLOTS$1.header }) : null, h("slot", null)));
