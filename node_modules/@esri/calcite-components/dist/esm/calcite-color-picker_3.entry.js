import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-527d390a.js';
import { f as focusElement, g as getElementDir } from './dom-9b1c8e39.js';
import { n as normalizeHex, C as CSSColorMode, p as parseMode, c as colorEqual, i as isValidHex, a as isLonghandHex, r as rgbToHex, h as hexToRGB, b as hexChar } from './utils-3aabad50.js';
...
const CalciteColorPickerSwatch = class {
  ...
  render() {
    ...
    return (h(Host, { "aria-label": hex, title: hex }, h("svg", { class: CSS$2.swatch, xmlns: "http://www.w3.org/2000/svg" }, h("rect", { fill: hex, height: "100%", rx: borderRadius, stroke: borderColor, width: "100%" }))));
  }
  static get watchers() { return {
    "color": ["handleColorChange"]
  }; }
