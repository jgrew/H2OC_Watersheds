...
import { n as nodeListToArray, g as getElementDir, c as getElementProp } from './dom-9b1c8e39.js';
import { g as getKey } from './key-477fdfc4.js';
import { g as guid } from './guid-09142681.js';
import { u as updatePopper, c as createPopper, C as CSS$2 } from './popper-c4f073f9.js';
...
const CalciteComboboxItemGroup = class {
  ...
  render() {
    ...
    const dir = getElementDir(el);
    const indent = `${CSS$1.label}--indent-${getDepth(el)}`;
    return (h(Host, { dir: dir, scale: scale }, h("ul", { "aria-labelledby": this.guid, class: CSS$1.list, role: "group" }, h("li", { class: { [CSS$1.label]: true, [indent]: true }, id: this.guid, role: "presentation" }, h("span", { class: CSS$1.title }, this.label)), h("slot", null))));
  }
  get el() { return getElement(this); }
};
